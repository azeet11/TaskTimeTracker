...
{
    /// <inheritdoc />
    public partial class AddApplicationWorkflowInstances : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperationWorkflowInstanceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OperationWorkflowConfigurationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    WorkflowSubStageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Remarks = table.Column<string>(type: "text", nullable: false),
                    WorkflowStageDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationWorkflowInstances_OperationWorkflowConfiguration_OperationWorkflowConfigurationId",
                        column: x => x.OperationWorkflowConfigurationId,
                        principalTable: "OperationWorkflowConfiguration",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationWorkflowInstances_OperationWorkflowInstance_OperationWorkflowInstanceId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationWorkflowInstances_WorkflowSubStage_WorkflowSubStageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationWorkflowInstances_OperationWorkflowConfigurationId",
                table: "ApplicationWorkflowInstances",
